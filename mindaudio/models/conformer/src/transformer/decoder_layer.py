...
class DecoderLayer(nn.Cell):
    ...
    def __init__(self,
        ...
        self.concat_dimlast = ops.Concat(axis=-1)
    ...
    def construct(
        ...
        tgt_q_mask = tgt_mask
        if self.concat_after:
            tgt_concat = self.concat_dimlast((tgt_q, self.self_attn(tgt_q, tgt, tgt, tgt_q_mask)))
        ...
        if self.concat_after:
            x_concat = self.concat_dimlast((x, self.src_attn(x, memory, memory, memory_mask)))
