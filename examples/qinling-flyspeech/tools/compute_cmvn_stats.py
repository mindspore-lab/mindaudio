...
class AudioDataset:
    ...
    def __getitem__(self, idx):
        ...
        xs = compute_fbank_feats(waveform,
                                 sample_rate,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--num_workers', default=0, type=int, help='num of subprocess workers for processing')
    ...
    ds = de.GeneratorDataset(dataset, ['number', 'mean_stat', 'var_stat'],
