...
def create_parser():
    ...
    group.add_argument('--pre_trained_model_path', type=str, default='', help='Pretrained checkpoint path')
    group.add_argument('--is_distributed', action="store_true", default=False, help='Distributed training')
