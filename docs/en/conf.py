...
project = 'mindaudio'
copyright = '2022, mindaudio contributors'
author = 'mindaudio contributors'

version_file = '../../mindaudio/version.py'
...
shutil.copy('../../examples/conformer/readme.md', './examples/conformer.md')
# shutil.copy('../../examples/deepspeech2/readme.md', './examples/deepspeech2.md')
shutil.copy('../../examples/tacotron2/readme.md', './examples/tacotron2.md')
# shutil.copy('../../examples/tokenisers/readme.md', './examples/tokenisers.md')
